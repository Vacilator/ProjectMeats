...
class ChatMessageAdmin(admin.ModelAdmin):
    ...
    fieldsets = (
        ('Basic Information', {
            'fields': ('id', 'session', 'message_type', 'owner')
        }),
        ('Content', {
            'fields': ('content_preview_full', 'content')
        }),
        ('Processing', {
...
class UploadedDocumentAdmin(admin.ModelAdmin):
    ...
    fieldsets = (
        ...
        ('File Information', {
            'fields': ('file', 'file_link', 'file_size', 'file_size_mb_display', 'file_type')
        }),
        ('Classification', {
            'fields': ('document_type', 'confidence_score', 'processing_status', 'is_processed_display')
        }),
        ('Extracted Content', {
        ...
        ('Processing', {
            'fields': ('processing_metadata', 'processing_error', 'created_entities'),
            'classes': ('collapse',)
        }),
        ('Timestamps', {
            'fields': ('created_on', 'modified_on'),
...
class ProcessingTaskAdmin(admin.ModelAdmin):
    ...
    fieldsets = (
        ...
        ('Status', {
            'fields': ('status', 'progress_percentage', 'error_details')
        }),
        ('Data', {
        ...
        ('Timing', {
            'fields': ('created_on', 'started_at', 'completed_at', 'duration_display'),
            'classes': ('collapse',)
        }),
    )
    ...
    def document_link(self, obj):
        """Link to document."""
        if obj.document:
            url = reverse('admin:ai_assistant_uploadeddocument_change', args=[obj.document.id])
