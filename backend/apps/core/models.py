...
class UserProfile(TimestampedModel):
    ...
    department = models.CharField(
        max_length=100, blank=True, null=True, help_text="User's department"
    )

    job_title = models.CharField(
        max_length=100, blank=True, null=True, help_text="User's job title"
    )
    ...
    email_notifications = models.BooleanField(
        default=True, help_text="Whether user wants to receive email notifications"
    )

    # Bio/notes
    bio = models.TextField(blank=True, null=True, help_text="User's biography or notes")
