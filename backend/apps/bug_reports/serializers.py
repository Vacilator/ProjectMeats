...
class BugReportSerializer(serializers.ModelSerializer):
    ...
    reporter_full_name = serializers.CharField(source='reporter.get_full_name', read_only=True)
    created_on_formatted = serializers.DateTimeField(source='created_on', format='%Y-%m-%d %H:%M:%S', read_only=True)
...
class BugReportListSerializer(serializers.ModelSerializer):
    ...
    priority_display = serializers.CharField(source='get_priority_display', read_only=True)
    status_display = serializers.CharField(source='get_status_display', read_only=True)
    priority_color = serializers.CharField(source='priority_display_color', read_only=True)
