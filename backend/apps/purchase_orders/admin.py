...
class PurchaseOrderAdmin(admin.ModelAdmin):
    ...
    fieldsets = (
        ('Basic Information (PowerApps: pro_purchaseorder)', {
            'fields': ('po_number', 'item', 'quantity', 'price_per_unit', 'status'),
    ...
    def mark_active(self, request, queryset):
        ...
        self.message_user(request, f'{updated} purchase order records marked as active.')
    ...
    def mark_inactive(self, request, queryset):
        ...
        self.message_user(request, f'{updated} purchase order records marked as inactive.')
