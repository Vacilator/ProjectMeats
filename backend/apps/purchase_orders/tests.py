...
class PurchaseOrderAPITest(APITestCase):
    ...
    def setUp(self):
        ...
        self.customer = Customer.objects.create(
            name="Test Customer", created_by=self.user, modified_by=self.user, owner=self.user
        )

        self.supplier = Supplier.objects.create(
            name="Test Supplier", created_by=self.user, modified_by=self.user, owner=self.user
        )
