...
from apps.suppliers.models import Supplier, SupplierPlantMapping, SupplierLocation
    ...
    test_data = [
        {
            ...
            'accounts_receivable': accounts_receivables[0] if accounts_receivables else None,
            'status': 'active'
        },
        {
            ...
            'accounts_receivable': accounts_receivables[1] if len(accounts_receivables) > 1 else None,
            'status': 'active'
        },
        {
        ...
        },
        {
            ...
            'accounts_receivable': accounts_receivables[2] if len(accounts_receivables) > 2 else None,
            'status': 'inactive'
        }
    ]
...
def create_customers(users):
    ...
    test_data = [
        {
            'name': 'Restaurant Chain Holdings',
            'status': 'active'
        },
        {
            'name': 'Wholesale Food Distributors',
            'status': 'active'
        },
        {
...
def main():
    ...
    supplier_locations = create_supplier_locations(users, suppliers)
    contacts = create_contact_info(users, suppliers, customers)
    carriers = create_carrier_info(users, suppliers)
    purchase_orders = create_purchase_orders(users, suppliers, customers)
    mappings = create_supplier_plant_mappings(users, suppliers, plants, customers, contacts)
