...
echo "   3. Set environment variables (recommended):"
echo -e "${CYAN}      export GITHUB_USER=your_username${NC}"
echo -e "${CYAN}      export GITHUB_TOKEN=your_token${NC}"
echo -e "${CYAN}      sudo -E ./master_deploy.py${NC}"
echo "   4. Or use direct clone:"
